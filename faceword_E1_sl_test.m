...
fs_cosmo_sesssl(sessListE1, anaListE1, contraPairsE1(1:5, :), ...
    'runlist', 'run_main.txt', 'surftype', 'white', 'ispct', 1, 'area', 100, ...
    'cvslopts', {'radius', 10, 'nproc', 10});

% % maximum area 100mm2 (test)
fs_cosmo_sesssl(sessListE1{1}, anaListE1{1}, contraPairsE1(1, :), ...
    'runlist', 'run_main.txt', 'surftype', 'white', 'ispct', 1, 'area', 123, ...
    'cvslopts', {'nproc', 10});
